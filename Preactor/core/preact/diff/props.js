...
// Jiu: We have to use Map<event.timestamp, _dispatched> because Event objects are pooled in Unity so the WeakMap is referencing the same object
const eventDispatchTimes = new Map();
