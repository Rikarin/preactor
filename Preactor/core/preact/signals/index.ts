import { options, Component, isValidElement } from '../index';
import { useRef, useMemo, useEffect } from '../hooks';
import { signal, computed, batch, effect, Signal, type ReadonlySignal, untracked } from '../signals-core';
import {
  VNode,
  OptionsTypes,
  HookFn,
...
hook(OptionsTypes.HOOK, (old, component, index, type) => {
  if (type < 3 || type === 9) (component as AugmentedComponent)._updateFlags |= HAS_HOOK_STATE;
